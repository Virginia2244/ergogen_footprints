    ...
    body: p => {
      ...
      const get_solder_pads = () => {
        ...
        for (let i = 0; i < 7; i++) {
          ...
          //Right Front inserts
          solder_pads += `(pad 1 smd custom (at 4.775 ${7.62 - (i)*2.54} ${180 + p.rot}) (size 0.2 0.2) (layers F.Cu F.Mask) ${pin_nets[i][1]}
          (zone_connect 2)
          (options (clearance outline) (anchor rect))
          (primitives
            (gr_poly (pts
          ...
          //Right Front inserts
          solder_pads += `(pad 1 smd custom (at -4.775 ${7.62 - (i)*2.54} ${p.rot}) (size 0.2 0.2) (layers B.Cu B.Mask) ${pin_nets[i][1]}
          (zone_connect 2)
          (options (clearance outline) (anchor rect))
          (primitives
            (gr_poly (pts
          ...
          //Right VIAS
          solder_pads += `(pad 1 thru_hole circle (at 3.262 ${7.62 - (i)*2.54}) (size 0.8 0.8) (drill 0.4) (layers *.Cu *.Mask) ${pin_nets[i][1]})\n`
        }
        return solder_pads
      }
